...
class SeleniumController:
    ...
    def _verify_x_post_published(self, text: str, timeout: int = 45) -> bool:
        if self.driver is None:
            return False
    ...
    def reply_to_tweet(self, tweet_url: str, reply_text: str) -> bool:
        ...
        def _reply_timeout(_signum, _frame):
            raise TimeoutException("Reply to tweet exceeded hard timeout")
