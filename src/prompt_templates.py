...
- Reject low-quality poll bait, election-denial bait, partisan outrage bait, and yes/no engagement bait
- Never ask whether Trump won the 2020 election or repeat claims about a stolen/rigged 2020 election
- If the source is mostly political outrage with no market/economy/trade signal, output SKIP
...
- Continue crypto and cryptography posts
